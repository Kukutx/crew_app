...
class UserProfile {
  ...
  UserProfile copyWith({bool? followed, int? followers}) => UserProfile(
        uid: uid,
        name: name,
        bio: bio,
        avatar: avatar,
...
final _profileProvider = StateProvider<UserProfile>((ref) {
  return UserProfile(
    uid: 'u_001',
    name: 'Luna',
...
/// ====== 主页面 ======
class TestUserProfile extends ConsumerStatefulWidget {
  const TestUserProfile({super.key});
  @override
  ConsumerState<TestUserProfile> createState() => _ProfilePageState();
}

class _ProfilePageState extends ConsumerState<TestUserProfile>
  ...
  Future<void> _onRefresh() async {
    // 实际项目里触发 ref.invalidate(...) 重新拉取 Firestore 数据
                ...
                background: Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      right: 16,
                      bottom: 16,
                      child: _HeaderCard(profile: profile),
                    ),
                  ],
                ),
              ),
                ...
                child: DefaultTextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          _Stat('粉丝', profile.followers),
                          _Dot(),
                          _Stat('关注', profile.following),
                          _Dot(),
                          _Stat('获赞', profile.likes),
                        ],
                      ),
                    ],
                  ),
