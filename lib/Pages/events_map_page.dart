...
import 'package:crew_app/Models/event_data.dart';
...
class EventsMapPageState extends State<EventsMapPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.selectedEvent != null) {
        ...
        _showEventDetails(ev); // 可选：弹出详情BottomSheet
  ...
  Widget build(BuildContext context) {
    final startCenter =
        userLocation ?? LatLng(48.8566, 2.3522); // 默认巴黎，如果没有用户坐标，作为地图视觉中心
    return Scaffold(
      appBar: AppBar(title: Text("Events (OpenStreetMap)")),
      body: FlutterMap(
