...
class ParticipantBubble extends StatefulWidget {
  ...
  static const double defaultExpenseBubbleDiameter = 56; // 从72减小到56，与cluster保持一致
...
class _ParticipantBubbleState extends State<ParticipantBubble>
  ...
  Widget build(BuildContext context) {
    ...
    final maxExpenseSize = baseExpenseSize * parentScaleFactor * 1.2; // 1.2 是最大金额比例
                            ...
                            return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // 显示应收/应付状态
                                  if (widget.allParticipants.length > 1) ...[
            ...
            ...(() {
              ...
              return List.generate(expenses.length, (index) {
                ...
                final amountRatio = maxExpenseAmount > 0
                    ...
                    : 1.0;
                final sizeScale = 0.8 + (amountRatio * 0.4); // 0.8 到 1.2
  ...
  List<Widget> _buildExpenseConnections(
    List<ParticipantExpense> expenses,
    double orbitRadius,
    double stackExtent,
    bool isDark,
  ) {
  ...
  List<Color> _getBubbleGradient(ThemeData theme, bool isDark) {
    final balance = widget.participant.balance(widget.allParticipants);
    if (balance > 0) {
      // 应收（绿色系）
      return isDark
          ? [
