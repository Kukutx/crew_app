...
class CreateRoadTripPage extends ConsumerStatefulWidget {
  const CreateRoadTripPage({super.key, required this.onClose});
...
class _CreateRoadTripPageState extends ConsumerState<CreateRoadTripPage> {
  ...
  Future<void> _submit() async {
    ...
    final input = CreateRoadTripInput(
      ...
      pricePerPerson: _priceCtrl.text.isEmpty
          ? null
    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('创建成功：$id')));
          ...
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) =>
                    (v == null || v.trim().isEmpty) ? '请输入起点位置' : null,
              ),
