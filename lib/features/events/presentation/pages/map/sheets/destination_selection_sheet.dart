...
class _DestinationSelectionSheetState extends State<DestinationSelectionSheet> {
  ...
  bool get _canCreate =>
      !_isSubmitting && widget.destinationListenable.value != null;
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      FutureBuilder<String?>(
                        key: ValueKey(
                          '${position.latitude}_${position.longitude}_start_trip',
                        ),
